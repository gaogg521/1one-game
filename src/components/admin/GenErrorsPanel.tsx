...
type GenerationJob = {
  ...
  usage: { calls: number; succeeded: number; durationMs: number; costMicros: number | null; provider: string; model: string } | null;
  cost: { estimatedMicros: number | null; status: "usage_ledger" | "configured_estimate" | "not_configured" };
