    ...
    <AppPageShell>
      ...
      <AppMain>
        <main className="@container/main relative flex min-h-full w-full flex-col">
          ...
          <div className="mx-auto mt-10 w-full max-w-6xl px-5 sm:mt-12 sm:px-10 lg:px-14">
            <MobileFeedPromoStrip />
          </div>

          <HomeFeaturedSections />

          <section className="px-5 py-12 sm:px-10 sm:py-14 lg:px-14 xl:px-20 2xl:px-28">
            <div className="mx-auto max-w-6xl">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between lg:gap-8">
                <div>
                  ...
                  <h2 className="mt-2 text-xl font-medium tracking-tight text-[var(--gc-text)] sm:text-2xl">
                    {t("home.strategyTitle")}
                  </h2>
                  <p className="mt-2 max-w-2xl text-sm leading-relaxed text-[var(--gc-muted)]">
                    {t("home.literaryPipelineDesc")}
                  </p>
                </div>
                <Link
                  href={withLocalePath("/start", locale)}
                  className="self-start rounded-full border border-[color:color-mix(in_srgb,var(--gc-accent)_35%,transparent)] px-5 py-2 text-sm font-medium text-[color:color-mix(in_srgb,var(--gc-accent)_95%,white)] transition hover:bg-[color:color-mix(in_srgb,var(--gc-accent)_10%,transparent)] lg:self-auto"
                >
          ...
          <section className="mt-auto border-t border-[color:var(--gc-border)] px-5 py-12 sm:px-10 sm:py-14 lg:px-14 xl:px-20 2xl:px-28">
            <div className="mx-auto max-w-6xl">
              <p
                className="font-medium tracking-tight text-[var(--gc-text)]"
                style={{ fontSize: "clamp(1.45rem, 0.7rem + 2.2cqi, 2.4rem)", lineHeight: 1.15 }}
              >
                {t("home.ctaTitle")}
              </p>
              <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[var(--gc-muted)]">
                {t("home.ctaDesc")}
              </p>
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="rounded-full border border-[color:var(--gc-border)] px-6 py-2.5 text-sm font-medium text-[var(--gc-muted)] transition hover:text-[var(--gc-text)]"
                >
