...
export const SAMPLES: Sample[] = [
  ...
  {
    id: "voxel-power-frontier",
    title: "Voxel Power Frontier",
    subtitle: "方块采集 · 超能建造 · 核心完成",
    prompt: "做一个原创方块沙盒挑战：移动探索、挖掘能量方块、切换快捷栏并放置建筑模块，收集 8 个能量核心后完成基地。",
    tags: ["方块", "沙盒", "采集", "建造"], coverImageSrc: "/samples/voxel-power-frontier.png", coverAlt: "Voxel Power Frontier gameplay cover",
    coverGradient: "linear-gradient(145deg,#1d4ed8,#22c55e,#facc15)", accentGlow: "rgba(34,197,94,.42)", emoji: "🧱", plays: "New", creator: "operone", shelf: "featured", badge: "new", photoCover: true,
  },
  {
    id: "neon-territory-loop",
    title: "Neon Territory Loop",
    subtitle: "轨迹圈地 · 风险扩张 · 面积胜利",
    prompt: "做一个原创 .io 圈地游戏：从安全领地出发绘制轨迹，闭合后占领区域，轨迹暴露时有风险，达到目标面积即胜利。",
    tags: ["圈地", "IO", "领地", "街机"], coverImageSrc: "/samples/neon-territory-loop.png", coverAlt: "Neon Territory Loop gameplay cover",
    coverGradient: "linear-gradient(145deg,#020617,#0891b2,#22d3ee)", accentGlow: "rgba(34,211,238,.42)", emoji: "🟦", plays: "New", creator: "operone", shelf: "featured", badge: "new", photoCover: true,
  },
  {
    id: "hundred-gate-breaker",
    title: "Hundred Gate Breaker",
    subtitle: "蓄力重拳 · 百层破壁 · 阶段推进",
    prompt: "做一个原创重拳闯关游戏：连续点击蓄力并击穿十段、共一百层防线，每段更坚固，全部击破后完成挑战。",
    tags: ["动作", "点击", "破坏", "闯关"], coverImageSrc: "/samples/hundred-gate-breaker.png", coverAlt: "Hundred Gate Breaker gameplay cover",
    coverGradient: "linear-gradient(145deg,#7c2d12,#f97316,#fde047)", accentGlow: "rgba(249,115,22,.42)", emoji: "👊", plays: "New", creator: "operone", shelf: "featured", badge: "new", photoCover: true,
  },
  {
    id: "grand-estate-merge",
    title: "Grand Estate Merge",
    subtitle: "建筑合成 · 庄园升级 · 终局完成",
    prompt: "做一个原创庄园合成游戏：在棋盘上合并同阶建筑，从木料逐步升级为工坊、住宅和中央庄园，合成最高阶建筑即胜利。",
    tags: ["合成", "庄园", "建造", "休闲"], coverImageSrc: "/samples/grand-estate-merge.png", coverAlt: "Grand Estate Merge gameplay cover",
    coverGradient: "linear-gradient(145deg,#78350f,#d97706,#fde68a)", accentGlow: "rgba(251,191,36,.4)", emoji: "🏡", plays: "New", creator: "operone", shelf: "featured", badge: "new", photoCover: true,
  },
  {
    id: "blockland-sharpshooter",
    title: "Blockland Sharpshooter",
    subtitle: "远距瞄准 · 有限弹药 · 精准清场",
    prompt: "做一个原创低多边形狙击游戏：使用瞄准镜寻找远处目标，有限弹药下完成 8 次精准命中，命中距离影响得分。",
    tags: ["狙击", "瞄准", "射击", "精准"], coverImageSrc: "/samples/blockland-sharpshooter.png", coverAlt: "Blockland Sharpshooter gameplay cover",
    coverGradient: "linear-gradient(145deg,#14532d,#365314,#ef4444)", accentGlow: "rgba(239,68,68,.4)", emoji: "🎯", plays: "New", creator: "operone", shelf: "featured", badge: "new", photoCover: true,
  },
  {
    id: "voxel-daybreak-survival",
    title: "Voxel Daybreak Survival",
    subtitle: "资源采集 · 三日生存 · 黎明结算",
    prompt: "做一个原创方块世界生存游戏：白天采集资源并建设庇护所，夜晚抵挡威胁，连续熬过三个昼夜后胜利。",
    tags: ["生存", "方块", "昼夜", "采集"], coverImageSrc: "/samples/voxel-daybreak-survival.png", coverAlt: "Voxel Daybreak Survival gameplay cover",
    coverGradient: "linear-gradient(145deg,#0f172a,#1d4ed8,#facc15)", accentGlow: "rgba(250,204,21,.4)", emoji: "🌅", plays: "New", creator: "operone", shelf: "trending", badge: "new", photoCover: true,
  },
  {
    id: "passenger-rail-express",
    title: "Passenger Rail Express",
    subtitle: "三轨换道 · 站台接客 · 满载完成",
    prompt: "做一个原创列车接客游戏：列车自动前进，玩家在三条轨道间换道，在站台准确停车接载乘客，接满 12 人后完成线路。",
    tags: ["列车", "换道", "乘客", "街机"], coverImageSrc: "/samples/passenger-rail-express.png", coverAlt: "Passenger Rail Express gameplay cover",
    coverGradient: "linear-gradient(145deg,#1e3a8a,#38bdf8,#e0f2fe)", accentGlow: "rgba(56,189,248,.4)", emoji: "🚆", plays: "New", creator: "operone", shelf: "trending", badge: "new", photoCover: true,
  },
  {
    id: "fusion-legends-arena",
    title: "Fusion Legends Arena",
    subtitle: "英雄合并 · 阶位成长 · 终极阵容",
    prompt: "做一个原创英雄融合游戏：招募并拖动两个同阶英雄进行合并升级，逐级增强战力，完成最高阶阵容即胜利。",
    tags: ["英雄", "合成", "成长", "阵容"], coverImageSrc: "/samples/fusion-legends-arena.png", coverAlt: "Fusion Legends Arena gameplay cover",
    coverGradient: "linear-gradient(145deg,#312e81,#7c3aed,#c4b5fd)", accentGlow: "rgba(167,139,250,.42)", emoji: "🦸", plays: "New", creator: "operone", shelf: "trending", badge: "new", photoCover: true,
  },
  {
    id: "sparkle-auto-spa",
    title: "Sparkle Auto Spa",
    subtitle: "泡沫清洗 · 冲水抛光 · 顾客耐心",
    prompt: "做一个原创洗车服务游戏：依次完成除泥、打泡沫、冲水和抛光，顾客有耐心值，完成三辆汽车后胜利。",
    tags: ["洗车", "模拟", "服务", "流程"], coverImageSrc: "/samples/sparkle-auto-spa.png", coverAlt: "Sparkle Auto Spa gameplay cover",
    coverGradient: "linear-gradient(145deg,#0e7490,#22d3ee,#f0fdfa)", accentGlow: "rgba(34,211,238,.4)", emoji: "🚿", plays: "New", creator: "operone", shelf: "trending", badge: "new", photoCover: true,
  },
  {
    id: "red-blue-arsenal",
    title: "Red & Blue Arsenal",
    subtitle: "双队对抗 · 武器升级 · 十杀胜利",
    prompt: "做一个原创双队竞技射击游戏：蓝队与红队在小型竞技场交战，击破敌人后自动升级武器，先取得 10 次击破的一方胜利。",
    tags: ["团队", "射击", "竞技", "升级"], coverImageSrc: "/samples/red-blue-arsenal.png", coverAlt: "Red and Blue Arsenal gameplay cover",
    coverGradient: "linear-gradient(145deg,#1d4ed8,#172554,#dc2626)", accentGlow: "rgba(96,165,250,.4)", emoji: "🔫", plays: "New", creator: "operone", shelf: "trending", badge: "new", photoCover: true,
  },
  {
    id: "dou-dizhu",
    title: "枭牌·三席残局",
