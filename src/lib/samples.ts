...
export const PRUNED_SAMPLE_IDS = [
  ...
  "hundred-gate-breaker",
  "blockland-sharpshooter",
  "voxel-daybreak-survival",
...
export const SAMPLES: Sample[] = [
  ...
  },
  {
    ...
    subtitle: "第一人称探索 · 方块采掘 · 反应堆建造",
    prompt: "做一个原创第一人称方块沙盒挑战：WASD 移动、拖动视角、准星选取并挖掘方块，管理背包和扫描能力；开采 3 个能量核心并放置 4 个结构方块完成反应堆。",
  ...
  },
  {
    ...
    subtitle: "真实闭环圈地 · 敌人切线 · 20% 面积胜利",
    prompt: "做一个原创 .io 圈地游戏：从安全领地出发绘制脆弱轨迹，返回安全区后闭环并填充区域；敌人可切断未闭合轨迹，拥有三条命，占领 20% 地图即胜利。",
  ...
  },
  {
    ...
    subtitle: "5×5 拖放合成 · 资源经营 · 最高阶庄园",
    prompt: "做一个原创庄园合成游戏：在 5×5 棋盘拖放建筑，两个同阶建筑才能合并；管理金币和能量，从 16 个木料堆连续完成 15 次合并，建成最高阶中央大庄园即胜利。",
