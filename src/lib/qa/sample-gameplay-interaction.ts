...
export const SAMPLE_GAMEPLAY_CASES: SampleGameplayCase[] = [
  ...
  { sampleId: "crashy-roads", expectedScene: "CoasterScene", interaction: "arrow-left", animated: true, clickBurst: 3 },
  ...
  { sampleId: "gun-merge-3d-zombie-apocalypse", expectedScene: "TowerDefenseScene", interaction: "click-lower", animated: true, clickRel: { x: 0.62, y: 0.68 } },
  ...
  { sampleId: "elastic-thief-2", expectedScene: "PlatformerScene", interaction: "arrow-right", animated: true, clickBurst: 4 },
  ...
  { sampleId: "blade-defender-merge", expectedScene: "TowerDefenseScene", interaction: "click-lower", animated: true, clickRel: { x: 0.45, y: 0.7 } },
  ...
  { sampleId: "pottery-master-3d", expectedScene: "CustomizationScene", interaction: "click-center", clickRel: { x: 0.5, y: 0.46 }, clickBurst: 3 },
];
