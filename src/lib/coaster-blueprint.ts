...
export function buildCoasterBlueprint(opts: { prompt?: string; spec?: GameSpec }): CoasterBlueprint {
  ...
  return { path, targetTimeSec, cameraDistance };
}
